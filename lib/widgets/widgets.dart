...
Widget appBar(BuildContext context){
  return RichText(
    text: TextSpan(
      ...
      children: <TextSpan>[
        TextSpan(text: 'Quiz', style: TextStyle(fontWeight: FontWeight.w400, color: Colors.black45)),
        TextSpan(text: 'Maker', style: TextStyle(fontWeight: FontWeight.w500, color: Colors.blue)),
      ],
    ),
  );
}
